...
A single-file, self-hosted learning dashboard for a complete self-directed program in **semiconductor process engineering** — with an optional built-in AI coach and an explicit strategy for using AI to learn *faster without learning less*.
